...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-3 rounded-xl border border-blue-200 bg-blue-50 px-5 py-4 text-blue-800 dark:border-blue-500/20 dark:bg-blue-500/10 dark:text-blue-200">
        ...
        <span class="flex-1 text-sm font-medium">Halaman ini hanya menampilkan riwayat variabel eksternal yang dicatat dalam <strong>24 jam terakhir</strong>. Data yang lebih lama tetap tersimpan di database dan dapat diakses melalui halaman daftar utama atau ekspor laporan.</span>
    </div>
